...
//
module ice40_nano (gpio_00_i, gpio_00_o, gpio_en_00_o, rstn_i, clk_i, 
            uart_rxd_00_i, uart_txd_00_o);
    input [7:0]gpio_00_i;
    output [7:0]gpio_00_o;
    output [7:0]gpio_en_00_o;
    input rstn_i;
    input clk_i;
    input uart_rxd_00_i;
    ...
    wire pll0_inst_outglobal_o_net, cpu0_inst_system_resetn_o_net, ahbl0_inst_AHBL_M01_interconnect_HREADYOUT, 
    ...
    wire pll0_inst_lock_o_net, gpio0_inst_INTR_interconnect_IRQ, uart0_inst_INT_M0_interconnect_IRQ, 
    ...
    ahbl0 ahbl0_inst (.ahbl_m01_hrdata_mstr_i({ahbl0_inst_AHBL_M01_interconnect_HRDATA}), 
          ...
          .ahbl_hclk_i(pll0_inst_outglobal_o_net), .ahbl_hresetn_i(cpu0_inst_system_resetn_o_net), 
    ...
    defparam ahbl0_inst.S1_ADDR_RANGE = 32'h00002400;
    ...
    ahbl2apb0 ahbl2apb0_inst (.ahbl_haddr_i({ahbl0_inst_AHBL_M01_interconnect_HADDR}), 
            ...
            .apb_pwdata_o({ahbl2apb0_inst_APB_M0_interconnect_PWDATA}), .clk_i(pll0_inst_outglobal_o_net), 
            .rst_n_i(cpu0_inst_system_resetn_o_net), .pclk_i(pll0_inst_outglobal_o_net), 
    ...
    apb0 apb0_inst (.apb_m01_prdata_mstr_i({apb0_inst_APB_M01_interconnect_PRDATA}), 
         ...
         .apb_pclk_i(pll0_inst_outglobal_o_net), .apb_presetn_i(cpu0_inst_system_resetn_o_net), 
    ...
    defparam apb0_inst.S0_BASE_ADDR = 32'h00005000;
    defparam apb0_inst.S1_ADDR_RANGE = 32'h00000400;
    defparam apb0_inst.S1_BASE_ADDR = 32'h00003000;
    cpu0 cpu0_inst (.ahbl_m_instr_haddr_o({cpu0_inst_AHBL_M0_INSTR_interconnect_HADDR}), 
         ...
         .clk_i(pll0_inst_outglobal_o_net), .rst_n_i(pll0_inst_lock_o_net), 
         .system_resetn_o(cpu0_inst_system_resetn_o_net), .irq0_i(gpio0_inst_INTR_interconnect_IRQ), 
         .irq1_i(uart0_inst_INT_M0_interconnect_IRQ), .ahbl_m_instr_hwrite_o(cpu0_inst_AHBL_M0_INSTR_interconnect_HWRITE), 
    ...
    gpio0 gpio0_inst (.gpio_i({gpio_00_i}), .gpio_o({gpio_00_o}), .gpio_en_o({gpio_en_00_o}), 
          .apb_paddr_i({apb0_inst_APB_M01_interconnect_PADDR[5:0]}), .apb_pwdata_i({apb0_inst_APB_M01_interconnect_PWDATA}), 
          .apb_prdata_o({apb0_inst_APB_M01_interconnect_PRDATA}), .clk_i(pll0_inst_outglobal_o_net), 
          .resetn_i(cpu0_inst_system_resetn_o_net), .apb_penable_i(apb0_inst_APB_M01_interconnect_PENABLE), 
    ...
    pll0 pll0_inst (.ref_clk_i(clk_i), .rst_n_i(rstn_i), .lock_o(pll0_inst_lock_o_net), 
         .outglobal_o(pll0_inst_outglobal_o_net));
    ...
    uart0 uart0_inst (.apb_paddr_i({apb0_inst_APB_M00_interconnect_PADDR[5:0]}), 
          ...
          .rxd_i(uart_rxd_00_i), .txd_o(uart_txd_00_o), .clk_i(pll0_inst_outglobal_o_net), 
