...
*******************************************************************************/
(* ORIG_MODULE_NAME="ice40_ip_interface", LATTICE_IP_GENERATED="1" *) module ice40_ip_interface (clk, 
        resetn, 
        int_o, 
        HADDR, 
        HBURST, 
    ...
    input [1:0] ip_int_i ; 
    input ip_ack_i ; 
    ice40_ip_interface_ipgen_ice40_ip_if ice40_ip_if_inst (.clk(clk), 
                .resetn(resetn), 
                .int_o(int_o), 
                .HADDR(HADDR[31:0]), 
                .HBURST(HBURST[2:0]), 
...
module ice40_ip_interface_ipgen_ice40_ip_if (
    input clk, 
    input resetn, 
    output int_o, 
    input [31:0] HADDR, 
