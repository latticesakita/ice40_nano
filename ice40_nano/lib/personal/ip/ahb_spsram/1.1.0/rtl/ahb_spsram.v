...
*******************************************************************************/
(* ORIG_MODULE_NAME="ahb_spsram", LATTICE_IP_GENERATED="1" *) module ahb_spsram (HCLK, 
        HRESETn, 
        HADDR, 
        HBURST, 
        HTRANS, 
    ...
    ahb_spsram_ipgen_ahb_spsram_nano ahb_spsram_nano_inst (.HCLK(HCLK), 
                .HRESETn(HRESETn), 
                .HADDR(HADDR[31:0]), 
                .HBURST(HBURST[2:0]), 
                .HTRANS(HTRANS[1:0]), 
...
module ahb_spsram_ipgen_ahb_spsram_nano (
    input HCLK, 
    input HRESETn, 
    input [31:0] HADDR, 
    input [2:0] HBURST, 
    ...
    assign sram_maskwe = ((HSIZE[2:0] == 3'b0000) ? (4'b0001 << HADDR[1:0]) : ((HSIZE[2:0] == 3'b001) ? (4'b0011 << (HADDR[1] * 2)) : 4'b1111)) ; 
