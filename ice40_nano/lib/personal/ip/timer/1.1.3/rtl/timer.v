                    ...
                    if ((w_alarm1_fire && r_alarm_repeat[1])) 
                        ...
                        if ((w_alarm2_fire && r_alarm_repeat[2])) 
                            begin
                                ...
                                r_alarm_end_valid <=  4'b0100 ;
                            end
                        else
                            if ((w_alarm3_fire && r_alarm_repeat[3])) 
                                begin
                                    r_alarm_set <=  r_alarm3_set ;
                                    r_alarm_end_valid <=  4'b1000 ;
                                end
                            else
                                if (((ahb_access && hwrite_i) && (haddr_i[7:4] == 4'b0011))) 
                                    begin
                                        r_alarm_set <=  hwdata_i ;
                                        r_alarm_end_valid[0] <=  (haddr_i[3:2] == 2'b00) ;
                                        r_alarm_end_valid[1] <=  (haddr_i[3:2] == 2'b01) ;
                                        r_alarm_end_valid[2] <=  (haddr_i[3:2] == 2'b10) ;
                                        r_alarm_end_valid[3] <=  (haddr_i[3:2] == 2'b11) ;
                                    end
                                else
