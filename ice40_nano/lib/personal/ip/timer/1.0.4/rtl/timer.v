...
// 8'b0000_0000: int        :Alarm all (readonly)
...
// 8'b0110_0000: en0        :Alarm0 enable/disable
// 8'b0110_0100: en1        :Alarm1 enable/disable
// 8'b0110_1000: en2        :Alarm2 enable/disable
// 8'b0110_1100: en3        :Alarm3 enable/disable
    ...
    generate
        if ((USE_DSP == 1)) 
            ...
            begin : genblk1
                ...
                assign w_alarm_end = (w_ticks + hwdata_i) ; 
            end
    endgenerate
    // TIMER
    ...
    always
        ...
        begin
            if ((!resetn)) 
                ...
                if (((ahb_access && (~hwrite_i)) && (w_addr == 6'b0001_00))) 
                    begin
                        r_alarm_int[0] <=  0 ;
                    end
                else
                    if ((r_alarm0_end == w_ticks)) 
                        begin
    ...
    always
        ...
        begin
            if ((!resetn)) 
                ...
                if (((ahb_access && (~hwrite_i)) && (w_addr == 6'b0001_01))) 
                    begin
                        r_alarm_int[1] <=  0 ;
                    end
                else
                    if ((r_alarm1_end == w_ticks)) 
                        begin
    ...
    always
        ...
        begin
            if ((!resetn)) 
                ...
                if (((ahb_access && (~hwrite_i)) && (w_addr == 6'b0001_10))) 
                    begin
                        r_alarm_int[2] <=  0 ;
                    end
                else
                    if ((r_alarm2_end == w_ticks)) 
                        begin
    ...
    always
        ...
        begin
            if ((!resetn)) 
                ...
                if (((ahb_access && (~hwrite_i)) && (w_addr == 6'b0001_11))) 
                    begin
                        r_alarm_int[3] <=  0 ;
                    end
                else
                    if ((r_alarm3_end == w_ticks)) 
                        begin
                ...
                if ((ahb_access && hwrite_i)) 
                    begin
                        if ((w_addr == 6'b0011_00)) 
                            ...
                            if (((w_addr == 6'b0110_00) && hwdata_i[0])) 
                                begin
                                    r_alarm0_end <=  w_alarm_end ;
                                    r_alarm0_set <=  hwdata_i ;
                                end
                ...
                if ((ahb_access && hwrite_i)) 
                    begin
                        if ((w_addr == 6'b0011_01)) 
                            ...
                            if (((w_addr == 6'b0110_01) && hwdata_i[0])) 
                                begin
                                    r_alarm1_end <=  w_alarm_end ;
                                    r_alarm1_set <=  hwdata_i ;
                                end
                ...
                if ((ahb_access && hwrite_i)) 
                    begin
                        if ((w_addr == 6'b0011_10)) 
                            ...
                            if (((w_addr == 6'b0110_10) && hwdata_i[0])) 
                                begin
                                    r_alarm2_end <=  w_alarm_end ;
                                    r_alarm2_set <=  hwdata_i ;
                                end
                ...
                if ((ahb_access && hwrite_i)) 
                    begin
                        if ((w_addr == 6'b0011_11)) 
                            ...
                            if (((w_addr == 6'b0110_11) && hwdata_i[0])) 
                                begin
                                    r_alarm3_end <=  w_alarm_end ;
                                    r_alarm3_set <=  hwdata_i ;
                                end
