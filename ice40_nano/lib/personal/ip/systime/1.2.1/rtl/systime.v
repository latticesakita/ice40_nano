...
*******************************************************************************/
(* ORIG_MODULE_NAME="systime", LATTICE_IP_GENERATED="1" *) module systime (int_o, 
        ahbl_haddr_i, 
        ahbl_hburst_i, 
        ahbl_hrdata_o, 
        ahbl_hsize_i, 
    ...
    input clk_i ; 
    input resetn_i ; 
    systime_ipgen_timer_ahbl #(.PRESCALE(23),
...
//`define CLOCKS_EN
module systime_ipgen_timer_ahbl #(parameter PRESCALE = (24 - 1), 
        parameter USE_DSP = 1) (
    output int_o, 
    input [31:0] ahbl_haddr_i, 
    input [2:0] ahbl_hburst_i, 
    ...
    generate
        if ((USE_DSP == 1)) 
            begin : genblk1
                ...
                systime_ipgen_timer_dsp_acc32 ticks_i (.clk(clk), 
                            .resetn(resetn), 
                            ...
                            .d(32'd1), 
                            .acc(w_ticks)) ; 
                systime_ipgen_timer_dsp_add32 alarm_end_i (.clk(clk), 
                            .resetn(resetn), 
                            .A(w_ticks), 
                            .B(w_alarm_set), 
                            .O(w_alarm_end)) ; 
...
module systime_ipgen_timer_dsp_acc32 (
    input clk, 
    input resetn, 
    input enable, 
    input load, 
...
module systime_ipgen_timer_dsp_add32 (
    input clk, 
    input resetn, 
    input [31:0] A, 
    input [31:0] B, 
